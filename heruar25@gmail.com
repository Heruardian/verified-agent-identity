...
        description: 'cloud'
        required: true
        default: 'cloud AI Agent'

jobs:
  verify:did:iden3:billions:main:2VoKfENGUXiB5WYmBb7nPthLiyUEbQeTi4USgwFZpx
...
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "cloud", "description": "cloud AI Agent"}'
